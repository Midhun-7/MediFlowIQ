...
public class DataInitializer implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        AppUser drSmithUser = userRepository.save(new AppUser(
                "drsmith",
                passwordEncoder.encode("Doctor@123"),
                "Dr. Sarah Smith",
                Role.DOCTOR));

        AppUser drKumarUser = userRepository.save(new AppUser(
                "drkumar",
                passwordEncoder.encode("Doctor@123"),
                "Dr. Rajesh Kumar",
                Role.DOCTOR));

        AppUser drSurgeonUser = userRepository.save(new AppUser(
                "drsurgeon",
                passwordEncoder.encode("Doctor@123"),
                "Dr. Priya Nair",
                Role.DOCTOR));

        AppUser drNeuroUser = userRepository.save(new AppUser(
                "drneuro",
                passwordEncoder.encode("Doctor@123"),
                "Dr. Arun Menon",
                Role.DOCTOR));
        ...
        drSmith.setName("Dr. Sarah Smith");
        drSmith.setSpecialty("Cardiology");
        drSmith.setQualifications("MBBS, MD (Cardiology), FRCP");
        drSmith.setYearsOfExperience(12);
        drSmith.setConsultationFee(800);
        drSmith.setTotalPatientsDiagnosed(3241);
        drSmith.setSurgeon(false);
        drSmith.setAvgRating(4.8);
        drSmith.setTotalReviews(542);
        ...
        drKumar.setName("Dr. Rajesh Kumar");
        drKumar.setSpecialty("General Medicine");
        drKumar.setQualifications("MBBS, MD (Internal Medicine)");
        drKumar.setYearsOfExperience(8);
        drKumar.setConsultationFee(500);
        drKumar.setTotalPatientsDiagnosed(5812);
        drKumar.setSurgeon(false);
        drKumar.setAvgRating(4.6);
        drKumar.setTotalReviews(1023);
        drKumar.setBio("Experienced general physician specializing in diabetes and hypertension management.");
        drKumar.setAvailableFrom("10:00");
        ...
        drNair.setName("Dr. Priya Nair");
        drNair.setSpecialty("Orthopaedic Surgery");
        drNair.setQualifications("MBBS, MS (Orthopaedics), FRCS");
        drNair.setYearsOfExperience(15);
        drNair.setConsultationFee(1000);
        drNair.setTotalPatientsDiagnosed(2847);
        drNair.setSurgeon(true);
        drNair.setSurgerySuccessRate(98.2);
        drNair.setAvgRating(4.9);
        drNair.setTotalReviews(318);
        drNair.setBio("Leading orthopaedic surgeon specializing in joint replacement and sports injuries.");
        drNair.setAvailableFrom("08:00");
        ...
        drMenon.setName("Dr. Arun Menon");
        drMenon.setSpecialty("Neurology");
        drMenon.setQualifications("MBBS, DM (Neurology), PhD");
        drMenon.setYearsOfExperience(18);
        drMenon.setConsultationFee(1200);
        drMenon.setTotalPatientsDiagnosed(1956);
        drMenon.setSurgeon(true);
        drMenon.setSurgerySuccessRate(96.5);
        drMenon.setAvgRating(4.7);
        drMenon.setTotalReviews(204);
        drMenon.setBio("Neurologist and neurosurgeon with expertise in epilepsy and brain tumour management.");
        drMenon.setAvailableFrom("09:00");
        ...
        PatientAccount p1 = patientAccountRepository.save(new PatientAccount(
                "midhun@example.com",
        ...
        PatientAccount p2 = patientAccountRepository.save(new PatientAccount(
                "arjun@example.com",
                passwordEncoder.encode("Patient@123"),
                "Arjun Menon",
                "+91-9876543211",
        ...
        PatientAccount p3 = patientAccountRepository.save(new PatientAccount(
                "lakshmi@example.com",
                passwordEncoder.encode("Patient@123"),
                "Lakshmi Nair",
                "+91-9876543212",
        ...
        c1.setPatientAccount(p1);
        c1.setConditionName("Type 2 Diabetes Mellitus");
        c1.setIcdCode("E11");
        c1.setDiagnosedDate(LocalDate.of(2021, 3, 10));
        c1.setSeverity(Condition.Severity.STABLE);
        c1.setTreatingDoctor(drKumar);
        c1.setNotes("Well-controlled with medication. HbA1c 6.8%");
        conditionRepository.save(c1);

        Condition c2 = new Condition();
        c2.setPatientAccount(p1);
        c2.setConditionName("Hypertension");
        c2.setIcdCode("I10");
        c2.setDiagnosedDate(LocalDate.of(2022, 8, 5));
        c2.setSeverity(Condition.Severity.MONITORING);
        c2.setTreatingDoctor(drSmith);
        c2.setNotes("BP averaging 140/90. Medication adjusted last month.");
        conditionRepository.save(c2);

        Condition c3 = new Condition();
        c3.setPatientAccount(p2);
        c3.setConditionName("Lumbar Disc Herniation");
        c3.setIcdCode("M51.1");
        c3.setDiagnosedDate(LocalDate.of(2023, 1, 20));
        c3.setSeverity(Condition.Severity.MONITORING);
        c3.setTreatingDoctor(drNair);
        c3.setNotes("Post-surgery recovery. Physical therapy ongoing.");
        ...
        mr1.setPatientAccount(p1);
        mr1.setDoctor(drKumar);
        mr1.setHospital(h1);
        mr1.setVisitDate(LocalDateTime.of(2024, 11, 5, 10, 30));
        mr1.setVisitType(MedicalRecord.VisitType.CONSULTATION);
        ...
        mr2.setPatientAccount(p1);
        mr2.setDoctor(drSmith);
        mr2.setHospital(h1);
        mr2.setVisitDate(LocalDateTime.of(2024, 9, 12, 14, 0));
        mr2.setVisitType(MedicalRecord.VisitType.CONSULTATION);
        ...
        mr3.setPatientAccount(p1);
        mr3.setDoctor(drKumar);
        mr3.setHospital(h1);
        mr3.setVisitDate(LocalDateTime.of(2024, 6, 20, 9, 0));
        mr3.setVisitType(MedicalRecord.VisitType.LAB_RESULT);
        ...
        mr4.setPatientAccount(p2);
        mr4.setDoctor(drNair);
        mr4.setHospital(h2);
        mr4.setVisitDate(LocalDateTime.of(2024, 3, 15, 8, 0));
        mr4.setVisitType(MedicalRecord.VisitType.SURGERY);
        ...
        mr5.setPatientAccount(p2);
        mr5.setDoctor(drNair);
        mr5.setHospital(h2);
        mr5.setVisitDate(LocalDateTime.of(2024, 4, 10, 11, 0));
        mr5.setVisitType(MedicalRecord.VisitType.FOLLOW_UP);
        ...
        mr6.setPatientAccount(p3);
        mr6.setDoctor(drMenon);
        mr6.setHospital(h3);
        mr6.setVisitDate(LocalDateTime.of(2024, 8, 22, 15, 30));
        mr6.setVisitType(MedicalRecord.VisitType.CONSULTATION);
        ...
        rx1.setPatientAccount(p1);
        rx1.setDoctor(drKumar);
        rx1.setHospital(h1);
        rx1.setPrescribedDate(LocalDate.of(2024, 11, 5));
        rx1.setValidUntil(LocalDate.of(2025, 2, 5));
        ...
        rx2.setPatientAccount(p1);
        rx2.setDoctor(drSmith);
        rx2.setHospital(h1);
        rx2.setPrescribedDate(LocalDate.of(2024, 9, 12));
        rx2.setValidUntil(LocalDate.of(2025, 3, 12));
        ...
        rx3.setPatientAccount(p2);
        rx3.setDoctor(drNair);
        rx3.setHospital(h2);
        rx3.setPrescribedDate(LocalDate.of(2024, 4, 10));
        rx3.setValidUntil(LocalDate.of(2024, 7, 10));
        ...
        rx4.setPatientAccount(p3);
        rx4.setDoctor(drMenon);
        rx4.setHospital(h3);
        rx4.setPrescribedDate(LocalDate.of(2024, 8, 22));
        rx4.setValidUntil(LocalDate.of(2025, 2, 22));
        ...
        appt1.setPatientAccount(p1);
        appt1.setDoctor(drSmith);
        appt1.setHospital(h1);
        ...
        appt1.setRazorpayOrderId("order_demo_001");
        appt1.setRazorpayPaymentId("pay_demo_001");
        appt1.setAmountPaise(80000);
        appt1.setCurrency("INR");
        appt1.setQueuePosition(3);
        appointmentRepository.save(appt1);

        Appointment appt2 = new Appointment();
        appt2.setPatientAccount(p2);
        appt2.setDoctor(drNair);
        appt2.setHospital(h2);
        ...
        appt2.setRazorpayOrderId("order_demo_002");
        appt2.setRazorpayPaymentId("pay_demo_002");
        appt2.setAmountPaise(100000);
        appt2.setCurrency("INR");
        appt2.setQueuePosition(1);
        appointmentRepository.save(appt2);

        log.info("[Init] ✅ Seeded 2 sample appointments");
        log.info("[Init] ═══════════════════════════════════════════════════");
        log.info("[Init]   Phase 6 seed data complete!");
        log.info("[Init]   Patient logins: midhun@example.com / Patient@123");
        log.info("[Init]   Doctor logins:  drsmith / Doctor@123");
        log.info("[Init] ═══════════════════════════════════════════════════");
    }
}
